...
const dateUrl = document.currentScript.getAttribute('url')
...
async function saveData(){
    loader[0].className = 'loader' //start loading screen
    ...
    try{
        ...
        loader[0].className = 'loader hidden' // stop loading screen
    }catch(e){
        console.log(e)
    }
}
